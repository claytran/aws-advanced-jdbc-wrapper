...
public interface PluginService extends ExceptionHandler {
   ...
   *
   * @param writerImportant true, if a caller expect to get a topology with the latest confirmed writer
   * @param timeoutMs timeout in msec to wait till topology get refreshed and a new (or existing) writer is confirmed
   ...
   */
  boolean forceRefreshHostList(final boolean writerImportant, final long timeoutMs) throws SQLException;
