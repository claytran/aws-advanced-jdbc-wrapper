...
public class FailoverConnectionPlugin extends AbstractConnectionPlugin {
  ...
  protected void failoverReader() throws SQLException {
    ...
    try {
      ...
      while (!remainingHosts.isEmpty() && readerCandidateConn == null) {
        try {
          readerCandidate =
  ...
  public List<HostSpec> forceRefreshTopology() throws SQLException {
    this.pluginService.forceRefreshHostList();
    return null;
  }

  public void testPickNewConnection() throws SQLException {
    this.pickNewConnection();
  }
}
